  ...
  const team = [
    {
      ...
      bio: "IIT Bombay Student, 2nd-time founder. dedicated to unlocking potential — in teams, products, and communities",
    ...
    },
    {
      ...
      bio: 'IIT Bombay Student, driving product vision and innovation, previously AI Engineer Intern at FINMECHANICS',
    ...
    {
      name: 'Tec Narayan Brahmachari',
      role: 'CTO',
      imageSrc: '/Tech_Narayan_Brahmachari.png',
      bio: 'IIT Bombay CSE Student, Leads Backend of GradPipe, received a PPO from Google',
